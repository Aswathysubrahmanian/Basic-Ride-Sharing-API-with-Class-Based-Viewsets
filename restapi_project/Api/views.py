...
class CreateRideView(APIView):
    def post(self, request):
        ...
        return self.render_html_form(request, serializer)

    def render_html_form(self, request, serializer):
        return render(request, 'ride_request_form.html', {'serializer': serializer})
